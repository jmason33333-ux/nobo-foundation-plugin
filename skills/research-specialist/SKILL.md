...
- `project-brief.md` — what this research is for, client context, constraints
- `who-i-am.md` — user's role (shapes what level of detail and format they need)
- `project-log.md` — what's already been researched, communicated, or decided on this engagement
